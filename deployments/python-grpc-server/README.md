...
This repository implements a basic Tyk gRPC server that listens for *pre request* and *response plugins* received from the Tyk Gateway and outputs the incoming request payload in JSON format. 
