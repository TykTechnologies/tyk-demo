BEGIN {
    ...
    printf "%-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s\n",
        ...
        rl_fail_width, "RL Fail", rl_success_percent_width, "RL Success %", rate_200_width, "200 Rate", result_width, "Result"
}

{
    ...
    printf "%-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s\n",
        ...
        rl_fail_width, $7, rl_success_percent_width, $8, rate_200_width, $9, result_width, $10
}
