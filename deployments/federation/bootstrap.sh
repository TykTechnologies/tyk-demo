...
create_api "deployments/federation/data/apis-1.json" "$dashboard_admin_api_credentials" "$dashboard_user_api_key"
bootstrap_progress

create_api "deployments/federation/data/apis-2.json" "$dashboard_admin_api_credentials" "$dashboard_user_api_key"
bootstrap_progress

create_api "deployments/federation/data/apis-3.json" "$dashboard_admin_api_credentials" "$dashboard_user_api_key"
bootstrap_progress
