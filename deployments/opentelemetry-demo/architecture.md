...
This deployment integrates with **Tyk Gateway** for API management, providing enterprise-grade API security, rate limiting, and analytics alongside comprehensive observability through OpenTelemetry.
...
tyk-gateway(Tyk Gateway):::golang
tyk-dashboard(Tyk Dashboard):::golang
...
frontend-proxy -->|HTTP /api/*| tyk-gateway
frontend-proxy -->|HTTP| frontend
frontend-proxy -->|gRPC| flagd
frontend-proxy -->|HTTP| flagd-ui
frontend-proxy -->|HTTP| image-provider

tyk-gateway -->|HTTP| frontend

tyk-dashboard -.->|configures| tyk-gateway
