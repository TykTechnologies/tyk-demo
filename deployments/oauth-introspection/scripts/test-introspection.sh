...
echo "=================================="
echo "This script demonstrates proper OAuth client separation:"
echo "  • Token Generation: test-client"
echo "  • Token Introspection: tyk-introspection-client"
echo ""
...
test_direct_introspection() {
    ...
    echo "  Using introspection client: tyk-introspection-client"
...
main() {
    ...
    echo ""
    echo "📋 Test Overview:"
    echo "  • Tokens generated by: test-client"
    echo "  • Tokens introspected by: tyk-introspection-client (via Tyk plugin)"
    echo "  • Direct introspection tests use: tyk-introspection-client"
    echo ""
    ...
    echo "======================"
    echo "  Generation client: test-client"
    echo "  Introspection client: tyk-introspection-client"
    echo ""
