...
Tyk Demo provides a pre-configured Tyk deployment that comes with a wide range of pre-configured examples. It uses Docker Compose for speed and simplicity, enabling you to choose you the features you'd like to deploy.
